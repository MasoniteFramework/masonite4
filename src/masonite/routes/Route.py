...
class Route:
    ...
    def resource(self, base_url, controller):
        return [
            ...
            self.get(f"/{base_url}/create", f"{controller}@create").name(f"{base_url}.create"),
            ...
            self.get(f"/{base_url}/@id/edit", f"{controller}@edit").name(f"{base_url}.edit"),
            self.match(['put', 'patch'], f"/{base_url}/@id", f"{controller}@update").name(f"{base_url}.update"),
            self.delete(f"/{base_url}/@id", f"{controller}@destroy").name(f"{base_url}.destroy"),
        ]
