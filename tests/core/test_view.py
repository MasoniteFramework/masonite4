...
class TestView(TestCase):
    ...
    def test_can_pass_dict(self):
        self.assertTrue("test" in self.view.render('test', {"test": "test"}).get_content())
    ...
    def test_global_view_exists(self):
        ...
        self.assertFalse(self.view.exists('/tests/integrations/templates/not_available'))


    def test_view_gets_global_template(self):
        self.assertEqual(self.view.render('/tests/integrations/templates/test', {'test': 'test'}).get_content(), 'test')
    ...
    def test_composers_load_all_views_with_list(self):
        ...
        self.assertEqual(self.view.composers, {'home': {'test': 'test'}, 'test': {'test': 'test'}})
    ...
    def test_view_share_updates_dictionary_not_overwrite(self):
        ...
        self.view.render('test', {'var1': 'var1'})
        self.assertEqual(self.view.dictionary, {'test1': 'test1', 'test2': 'test2', 'var1': 'var1'})
