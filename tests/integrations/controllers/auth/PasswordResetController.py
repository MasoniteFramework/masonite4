...
class PasswordResetController:
    ...
    def store(self, auth: Auth, request: Request, response: Response):  # store password_reset record
    ...
    def store_changed_password(self, auth: Auth, request: Request, response: Response):  # store password_reset record
