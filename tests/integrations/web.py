...
Route.post("/password_reset", "auth.PasswordResetController@store").name("password_reset.store")
Route.get("/change_password", "auth.PasswordResetController@change_password").name("change_password")
Route.post("/change_password", "auth.PasswordResetController@store_changed_password").name("change_password.store")
